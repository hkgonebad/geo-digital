...
const Hero = () => {
  return (
    <section className="w-full py-12 md:py-24 diagonal-section bg-brand-green/10">
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 items-center">
          <div>
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight mb-6">
              <span className="text-black">A Complete Digital & Web Solutions Company</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button className="btn-secondary hover:bg-brand-green text-white">Learn More</Button>
            </div>
          </div>
